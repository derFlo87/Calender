...
public ArrayList<CalendarCollection>  date_collection_arr;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (day_string.get(position).equals(curentDateString)) {
			...
			v.setBackgroundColor(Color.parseColor("#7fffd4")); //current day
		} else {
			v.setBackgroundColor(Color.parseColor("#66cdaa")); //background color
		}
	...
	public View setSelected(View view,int pos) {
		...
		previousView.setBackgroundColor(Color.parseColor("#66cdaa"));
		}
	...
	public void setEventView(View v,int pos,TextView txt){
		...
		for (int i = 0; i < len; i++) {
			...
			if (day_string.get(pos).equals(date)) {
				v.setBackgroundColor(Color.parseColor("#836fff"));
